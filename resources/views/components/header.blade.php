...
<header class="pt-3 pb-3">
    <div class="container">
        <div class="">
            <div class="up-header flex grey500 justify-between text-xs mb-2 border-b-1 border-gray-300 pb-3 max-md:hidden">
    ...
    <label for="menu-toggle" class="cursor-pointer">
        <img src="{{ asset('storage/images/mobileBurger.png') }}" alt="burger">
    </label>
    
    
        <div class="absolute left-0 right-0 top-full bg-white border-t shadow-lg 
                md:hidden peer-checked:block hidden z-50">
        <div class="px-4 py-2 space-y-2">
            <a href="#" class="block py-3 text-gray-700 hover:text-blue-600 transition border-b border-gray-100 last:border-0">Акции</a>
            <a href="#" class="block py-3 text-gray-700 hover:text-blue-600 transition border-b border-gray-100 last:border-0">О компании</a>
            <a href="#" class="block py-3 text-gray-700 hover:text-blue-600 transition border-b border-gray-100 last:border-0">Адреса</a>
            <a href="#" class="block py-3 text-gray-700 hover:text-blue-600 transition border-b border-gray-100 last:border-0">Контакты</a>
        </div>
    </div>
